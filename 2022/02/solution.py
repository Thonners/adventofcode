...
round_score_part_one = {
    "A": {"X": 3, "Y": 6, "Z": 0},  # Rock
    "B": {"X": 0, "Y": 3, "Z": 6},  # Paper
    "C": {"X": 6, "Y": 0, "Z": 3},  # Scissors
}

round_score_part_two = {
    "X": 0,  # Lose
    "Y": 3,  # Draw
    "Z": 6,  # Win
}

shape_score_part_two = {
    "A": {"X": 3, "Y": 1, "Z": 2},  # Rock
    "B": {"X": 1, "Y": 2, "Z": 3},  # Paper
    ...
    with open(filepath, "r") as file:
        ...
        for line in file.readlines():
            if line.strip():
                ...
                this_round_score = (
                    shape_score_part_one[me] + round_score_part_one[them][me]
                )
                live_total += this_round_score
                print(
                    f"Them: {them}, Me: {me}, round score: {this_round_score}, total: {live_total}"
                )
            else:
                print(f"Empty line...")
    ...
    with open(filepath, "r") as file:
        ...
        for line in file.readlines():
            if line.strip():
                them, me = line.strip().split(" ")
                this_round_score = (
                    shape_score_part_two[them][me] + round_score_part_two[me]
                )
                live_total += this_round_score
                print(
                    f"Them: {them}, Me: {me}, round score: {this_round_score}, total: {live_total}"
